...
<div class="section">
<p>This guide walks you through the basic CRUD operations on a Coherence <a id="" title="" target="_blank" href="https://coherence.community/22.09.1-SNAPSHOT/api/java/com/tangosol/net/NamedMap.html">NamedMap</a>.</p>
...
<div class="section">
<p>The Coherence <a id="" title="" target="_blank" href="https://coherence.community/22.09.1-SNAPSHOT/api/java/com/tangosol/net/NamedMap.html">NamedMap</a> is an extension of Java&#8217;s <code>java.util.Map</code> interface
and as such, it has all the <code>Map</code> methods that a Java developer is familiar with. Coherence also has a
<a id="" title="" target="_blank" href="https://coherence.community/22.09.1-SNAPSHOT/api/java/com/tangosol/net/NamedMap.html">NamedCache</a> which extends <code>NamedMap</code> and is form more transient data
...
we will use a Coherence <a id="" title="" target="_blank" href="https://coherence.community/22.09.1-SNAPSHOT/api/java/com/tangosol/net/Session.html">Session</a> for this.
...
The <a id="" title="" target="_blank" href="https://coherence.community/22.09.1-SNAPSHOT/api/java/com/tangosol/io/Serializer.html">Serializer</a> implementation used by a <code>NamedMap</code> is configurable
...
<a id="" title="" target="_blank" href="https://coherence.community/22.09.1-SNAPSHOT/api/java/com/tangosol/io/ExternalizableLite.html">ExternalizableLite</a> interface for more control of serialization.
...
<div class="section">
<p>The Coherence <code>NamedMap</code> contains a <a id="" title="" target="_blank" href="https://coherence.community/22.09.1-SNAPSHOT/api/java/com/tangosol/net/NamedMap.html#getAll(java.util.Collection)">getAll(java.util.Collection)</a>
...
<div class="section">
<p>As already stated, a <a id="" title="" target="_blank" href="https://coherence.community/22.09.1-SNAPSHOT/api/java/com/tangosol/net/NamedMap.html">NamedCache</a> is typically used to store transient data
in caching use-cases.</p>

<p>The <code>NamedCache</code> has an alternative <a id="" title="" target="_blank" href="https://coherence.community/22.09.1-SNAPSHOT/api/java/com/tangosol/net/NamedCache.html#put(K,V,long)">put(K,V,long)</a> method
