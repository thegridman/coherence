...
<p>Coherence now also provides a <a id="" title="" target="_blank" href="https://coherence.community/21.12.6/api/java//com/tangosol/net/cache/NonBlockingEntryStore.html">NonBlockingEntryStore</a> interface for integrating with data sources that provide non-blocking APIs.
...
<p>There are similar methods to the above in existing <a id="" title="" target="_blank" href="https://coherence.community/21.12.6/api/java//com/tangosol/net/cache/CacheStore.html">CacheStore</a> and <a id="" title="" target="_blank" href="https://coherence.community/21.12.6/api/java//com/tangosol/net/cache/BinaryEntryStore.html">BinaryEntryStore</a> interfaces, however with the <a id="" title="" target="_blank" href="https://coherence.community/21.12.6/api/java//com/tangosol/net/cache/NonBlockingEntryStore.html">NonBlockingEntryStore</a> interface the calls are non-blocking thus Coherence does not expect the operation to be completed when control is returned. To allow the implementer to notify Coherence of operation completion, the <a id="" title="" target="_blank" href="https://coherence.community/21.12.6/api/java//com/tangosol/net/cache/StoreObserver.html">StoreObserver</a> is provided and <strong>must</strong> be called upon success or failure. This allows Coherence to process the result of the operation.</p>
...
<li data-value="3">the <code>load()</code> operation for the entry store that implements <code>NonBlockingEntryStore</code> is called; custom logic is provided a <a id="" title="" target="_blank" href="https://coherence.community/21.12.6/api/java//com/tangosol/util/BinaryEntry.html">BinaryEntry</a> with a null initial value
and a <a id="" title="" target="_blank" href="https://coherence.community/21.12.6/api/java//com/tangosol/net/cache/StoreObserver.html">StoreObserver</a>. The implementer performs the datastore operation(s) necessary to populate the cache entry.</li>
