...
<v-flex xs12 sm4 lg3>
<v-card>
<router-link to="/docs/core/07_partition_events_logging"><div class="card__link-hover"/>
</router-link>
<v-layout align-center justify-center class="">
<v-avatar size="150px">
...
<v-card-title primary class="headline layout justify-center">
<span style="text-align:center">Partition Events Logging</span>
</v-card-title>
<v-card-text class="caption">
<p></p>
<p>Logging of events that render partitions unavailable.</p>
</v-card-text>
</v-card>
</v-flex>
<v-flex xs12 sm4 lg3>
<v-card>
<router-link to="/docs/core/08_non_blocking"><div class="card__link-hover"/>
</router-link>
<v-layout align-center justify-center class="">
<v-avatar size="150px">
...
<v-card-title primary class="headline layout justify-center">
<span style="text-align:center">Non-Blocking Data Sources</span>
</v-card-title>
<v-card-text class="caption">
<p></p>
...
<v-flex xs12 sm4 lg3>
<v-card>
<router-link to="/docs/core/10_tls"><div class="card__link-hover"/>
</router-link>
<v-layout align-center justify-center class="">
<v-avatar size="150px">
<v-icon class="xxx-large">https</v-icon>
</v-avatar>
</v-layout>
<div class="px-3">
<v-divider class="indigo lighten-4"/>
...
<v-card-title primary class="headline layout justify-center">
<span style="text-align:center">TLS/SSL Enhancements</span>
</v-card-title>
<v-card-text class="caption">
<p></p>
