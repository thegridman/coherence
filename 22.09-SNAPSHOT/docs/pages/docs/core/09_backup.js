...
<div class="section">
<p>Prior to this change all Coherence <a id="" title="" target="_blank" href="https://coherence.community/22.09-SNAPSHOT/api/java//com/tangosol/net/NamedMap.html">NamedMap</a> requests are serviced by the primary owner of
the associated partition(s) (ignoring client side caches, i.e. <a id="" title="" target="_blank" href="https://coherence.community/22.09-SNAPSHOT/api/java//com/tangosol/net/cache/NearCache.html">NearCache</a> / <a id="" title="" target="_blank" href="https://coherence.community/22.09-SNAPSHOT/api/java//com/tangosol/net/cache/ContinuousQueryCache.html">CQC</a>). The <code>read-locator</code>
feature allows for certain requests (currently only <a id="" title="" target="_blank" href="https://coherence.community/22.09-SNAPSHOT/api/java//com/tangosol/util/ConcurrentMap.html#get(java.lang.Object)">NamedMap.get</a> or <a id="" title="" target="_blank" href="https://coherence.community/22.09-SNAPSHOT/api/java//com/tangosol/net/NamedMap.html#getAll(java.util.Collection)">NamedMap.getAll</a>) to be targetted to non-primary
...
when using the synchronous API against a mutating method (<a id="" title="" target="_blank" href="https://coherence.community/22.09-SNAPSHOT/api/java//com/tangosol/util/ConcurrentMap.html#put(K,V)">put</a> / <a id="" title="" target="_blank" href="https://coherence.community/22.09-SNAPSHOT/api/java//com/tangosol/util/InvocableMap.html#invoke(K,com.tangosol.util.InvocableMap.EntryProcessor)">invoke</a>), or receiving a notification
