...
public interface TopicService
    ...
    /**
     * Obtain the partition count for the service.
     *
     * @param sTopicName  the name of the topic to obtain the partition count for
     *
     * @return the partition count for the service
     */
    int getPartitionCount(String sTopicName);
