...
public abstract class SafeNamedTopic<V>
    ...
    public void setInternalNamedTopic(com.tangosol.net.topic.NamedTopic topic)
        ...
        if (internal != null)
            {
            internal.removeListener(m_listener);
            }
        __m_InternalNamedTopic = topic;
        if (__m_InternalNamedTopic != null)
            {
            __m_InternalNamedTopic.addListener(m_listener);
            }
        }
    ...
    protected class Listener
        ...
        public void onEvent(NamedTopicEvent evt)
            ...
            try
                {
                NamedTopicEvent event = evt.replaceSource(SafeNamedTopic.this);
