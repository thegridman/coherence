...
supports <a id="" title="" target="_blank" href="https://coherence.community/22.06-SNAPSHOT/api/java//com/tangosol/net/cache/BinaryEntryStore.html">BinaryEntryStore</a> which provides access to the serialized form of entries for
data sources capable of manipulating those. A variant of <code>BinaryEntryStore</code> is
the <a id="" title="" target="_blank" href="https://coherence.community/22.06-SNAPSHOT/api/java//com/tangosol/net/cache/NonBlockingEntryStore.html">NonBlockingEntryStore</a>
which, besides providing access to entries in their <a id="" title="" target="_blank" href="https://coherence.community/22.06-SNAPSHOT/api/java//com/tangosol/util/BinaryEntry.html">BinaryEntry</a> form,
...
<ul class="ulist">
<li>
<p>CacheLoader - <a id="" title="" target="_blank" href="https://coherence.community/22.06-SNAPSHOT/api/java/com/tangosol/net/cache/CacheLoader.html">CacheLoader</a> - defines an interface for loading
individual entries via a key or a collection keys from a backend <code>database</code>.</p>

</li>
<li>
<p>CacheStore - <a id="" title="" target="_blank" href="https://coherence.community/22.06-SNAPSHOT/api/java/com/tangosol/net/cache/CacheStore.html">CacheStore</a> - defines and interface for storing
...
<div class="section">
<p>The <a id="" title="" target="_blank" href="https://coherence.community/22.06-SNAPSHOT/api/java/com/tangosol/net/cache/CacheLoader.html">CacheLoader</a> interface defines the following methods:</p>
...
<div class="section">
<p>The <a id="" title="" target="_blank" href="https://coherence.community/22.06-SNAPSHOT/api/java/com/tangosol/net/cache/CacheStore.html">CacheStore</a> interface defines the following methods:</p>
